...
class RiverMonitoringForm extends StatefulWidget {
  ...
  RiverMonitoringForm({Key? key, required this.mode, required this.id})
      : super(key: key);
...
class _RiverMonitoringFormState extends State<RiverMonitoringForm> {
  ...
  final FormGroup form = fb.group({
    'userId': FormControl<String>(value: '', validators: [Validators.required]),
    ...
    'surroundings':
        FormControl<List>(value: [], validators: [Validators.required]),
  ...
  setForm() {
    form.control('userId').value =
    _waterTestDetail.userId;
    form.control('generalInformation.activityDate').value =
        generalInformation['activityDate'];
    form.control('generalInformation.activityTime').value =
    ...
    form.control('waterLevelAndWeather.airTemperature').value =
    ...
    for (var i = 0; i < riverPictures.length; i++) {
      ...
      riverDescriptionsEdit.add(
          TextEditingController(text: "${riverPictures[i]['description']}"));
      riverImgObj.add(riverPictures[i]);
    }
    for (var i = 0; i < surroundingPictures.length; i++) {
      surroundingImg.add(surroundingPictures[i]['imageURL']);
      selectedSurroundingImages.add(surroundingPictures[i]['imageURL']);
      surroundingDescriptionsEdit.add(
          TextEditingController(text: "${surroundingPictures[i]['description']}"));
      surroundingImgObj.add(surroundingPictures[i]);
    }
    for (var i = 0; i < floraPictures.length; i++) {
      floraImg.add(floraPictures[i]['imageURL']);
      selectedFloraImages.add(floraPictures[i]['imageURL']);
      floraDescriptionsEdit.add(
          TextEditingController(text: "${floraPictures[i]['description']}"));
      floraImgObj.add(floraPictures[i]);
    }
    for (var i = 0; i < faunaPictures.length; i++) {
      faunaImg.add(faunaPictures[i]['imageURL']);
      selectedFaunaImages.add(faunaPictures[i]['imageURL']);
      faunaDescriptionsEdit.add(
          TextEditingController(text: "${faunaPictures[i]['description']}"));
      faunaImgObj.add(faunaPictures[i]);
    }
    for (var i = 0; i < groupPictures.length; i++) {
      groupImg.add(groupPictures[i]['imageURL']);
      selectedGroupImages.add(groupPictures[i]['imageURL']);
      groupImageDescriptionsEdit.add(
          TextEditingController(text: "${groupPictures[i]['description']}"));
      groupImgObj.add(groupPictures[i]);
    }
    for (var i = 0; i < activityPictures.length; i++) {
      activityImg.add(activityPictures[i]['imageURL']);
      selectedActivityImages.add(activityPictures[i]['imageURL']);
      activityImageDescriptionsEdit.add(
          TextEditingController(text: "${activityPictures[i]['description']}"));
      activityImgObj.add(activityPictures[i]);
    }
    for (var i = 0; i < artworkPictures.length; i++) {
      artWorkImg.add(artworkPictures[i]['imageURL']);
      selectedArtworkImages.add(artworkPictures[i]['imageURL']);
      artworkDescriptionsEdit.add(
          TextEditingController(text: "${artworkPictures[i]['description']}"));
      artwrokImgObj.add(artworkPictures[i]);
    }
    ...
    form.control('waterTesting.dissolvedOxygen').value =
        waterTesting['dissolvedOxygen'];
    ...
    form.control('waterTesting.waterTemperature').value =
        waterTesting['waterTemperature'];
    form.control('waterTesting.totalDissolvedSolids').value =
        waterTesting['totalDissolvedSolids'];
    form.control('waterTesting.conductivity').value =
        waterTesting['conductivity'];
  ...
  _getCurrentLocation() async {
    try {
      ...
      String? locationName =
          "${placemark.name!}, ${placemark.street}, ${placemark.postalCode}, ${placemark.country}";
      setState(() {
  ...
  Future<void> pickImages(name, mode) async {
    ...
    setState(() {
      ...
      if (name == 'riverPicture') {
        ...
        _steps = _generateSteps();
        if (widget.mode != "add") {
          for(var i=0;i<=selectedSurroundingImages.length;i++) {
            if (selectedSurroundingImages[0].runtimeType == String) {
              selectedSurroundingImages.removeAt(0);
            }
          }
          _steps = _generateSteps();
        }
        ...
        _steps = _generateSteps();
        if (widget.mode != "add") {
          for(var i=0;i<=selectedFloraImages.length;i++) {
            if (selectedFloraImages[0].runtimeType == String) {
              selectedFloraImages.removeAt(0);
            }
          }
          _steps = _generateSteps();
        }
        ...
        _steps = _generateSteps();
        if (widget.mode != "add") {
          for(var i=0;i<=selectedFaunaImages.length;i++) {
            if (selectedFaunaImages[0].runtimeType == String) {
              selectedFaunaImages.removeAt(0);
            }
          }
          _steps = _generateSteps();
        }
        ...
        _steps = _generateSteps();
        if (widget.mode != "add") {
          for(var i=0;i<=selectedGroupImages.length;i++) {
            if (selectedGroupImages[0].runtimeType == String) {
              selectedGroupImages.removeAt(0);
            }
          }
          _steps = _generateSteps();
        }
        ...
        _steps = _generateSteps();
        if (widget.mode != "add") {
          for(var i=0;i<=selectedActivityImages.length;i++) {
            if (selectedActivityImages[0].runtimeType == String) {
              selectedActivityImages.removeAt(0);
            }
          }
          _steps = _generateSteps();
        }
        ...
        _steps = _generateSteps();
        if (widget.mode != "add") {
          for(var i=0;i<=selectedArtworkImages.length;i++) {
            if (selectedArtworkImages[0].runtimeType == String) {
              selectedArtworkImages.removeAt(0);
            }
          }
          _steps = _generateSteps();
        }
  ...
  _buildFormForStep(step) {
    switch (step) {
      ...
      case 1:
        return _waterAndWeatherInformation();
      case 2:
        return _surrounding();
      case 3:
        return _waterQuality();
      case 4:
        return _floraAndFauna();
      case 5:
        return _otherPictures();
      case 6:
  ...
  final List<Map<String, String>> fieldConfigs = [
    {
      'fieldName': 'waterTesting.waterTemperature',
    ...
    {
      'fieldName': 'waterTesting.totalDissolvedSolids',
          ...
          children: [
            ...
            ReactiveTextField<String>(
              ...
              decoration: InputDecoration(
                suffix: fieldName == "waterTesting.waterTemperature"
                    ? Text("°C")
                    : fieldName == "waterTesting.turbidity"
                        ? Text("NTU")
                        : fieldName == "waterTesting.conductivity"
                            ? Text("µs")
                            : fieldName == "waterTesting.pH"
                                ? Text("°C")
                                : fieldName ==
                                        "waterTesting.totalDissolvedSolids"
                                    ? Text("ppm")
                                    : fieldName == "waterTesting.alkalinity"
                                        ? Text("°C")
                                        : Text("mg/L"),
  ...
  Future<Map<String, dynamic>> getLocationFromPlaceId(String placeId) async {
    ...
    if (response.statusCode == 200) {
      ...
      form.control('generalInformation.latitude').value =
          "${decodedData['result']['geometry']['location']['lat']}";
      form.control('generalInformation.longitude').value =
          "${decodedData['result']['geometry']['location']['lng']}";
      return decodedData;
    } else {
  ...
  update() {
    for (int i = 0; i < selectedRiverImages.length; i++) {
      if (selectedRiverImages[i].runtimeType == XFile) {
        riverImgObj.add({
          "imageURL": "",
          "fileName": path.basename(selectedRiverImages[i].path),
          "description": riverDescriptions[i].text,
        ...
        riverImgObj[i]['description'] = riverDescriptionsEdit[i].text;
      }
    }
    for (int i = 0; i < selectedSurroundingImages.length; i++) {
      if (selectedSurroundingImages[i].runtimeType == XFile) {
        surroundingImgObj.add({
          "imageURL": "",
          "fileName": path.basename(selectedSurroundingImages[i].path),
          "description": surroundingDescriptions[i].text
        ...
        surroundingImgObj[i]['description'] = surroundingDescriptionsEdit[i].text;
      }
    }
    for (int i = 0; i < selectedFloraImages.length; i++) {
      if (selectedFloraImages[i].runtimeType == XFile) {
        floraImgObj.add({
          "imageURL": "",
          "fileName": path.basename(selectedFloraImages[i].path),
          "description": floraDescriptions[i].text
        ...
        floraImgObj[i]['description'] = floraDescriptionsEdit[i].text;
      }
    }
    for (int i = 0; i < selectedFaunaImages.length; i++) {
      if (selectedFaunaImages[i].runtimeType == XFile) {
        faunaImgObj.add({
          "imageURL": "",
          "fileName": path.basename(selectedFaunaImages[i].path),
          "description": faunaDescriptions[i].text
    ...
    for (int i = 0; i < selectedActivityImages.length; i++) {
      if (selectedActivityImages[i].runtimeType == XFile) {
        activityImgObj.add({
          "imageURL": "",
          "fileName": path.basename(selectedActivityImages[i].path),
          "description": activityImageDescriptions[i].text
  ...
  Future<void> activityDate() async {
  ...
  Future<void> activityTime() async {
    final selectedTime = await showTimePicker(
      context: context,
      initialTime: TimeOfDay.now(),
    );
    if (selectedTime != null) {
      activityTimeController.text = selectedTime.format(context);
      form.control('generalInformation.activityTime').value =
          activityTimeController.text;
    }
  }

  Widget buildWaterLevelItem(int index) {
    return Padding(
          ...
          GestureDetector(
            onTap: () {
              setState(() {
                ...
                form.control('waterLevelAndWeather.waterLevel').value =
                    WATERANDWEATHER.waterLevelLabels[index];
                _steps = _generateSteps();
              });
            },
  ...
  Widget buildWeatherCondition(int Index) {
    return Padding(
          ...
          GestureDetector(
            onTap: () {
              setState(() {
                ...
                form.control('waterLevelAndWeather.weather').value =
                    WATERANDWEATHER.weatherLabels[Index];
                _steps = _generateSteps();
              });
            },
            child: SvgPicture.asset(
  ...
  void riverPictureUploadButton(String source) async {
    ...
    if (camOrGallery.toString() == "Gallery") {
      pickImages('riverPicture', 'Gallery');
    } else if (camOrGallery.toString() == "Camera") {
      pickImages('riverPicture', 'Camera');
    }
  }

  void surroundingUploadButton(String source) async {
    var camOrGallery = await showDialog(
      context: context,
      builder: (BuildContext context) {
        return PictureOptions();
  ...
  void floraUploadButton(String source) async {
    var camOrGallery = await showDialog(
      context: context,
      builder: (BuildContext context) {
        return PictureOptions();
  ...
  void faunaUploadButton(String source) async {
    var camOrGallery = await showDialog(
      context: context,
      builder: (BuildContext context) {
        return PictureOptions();
  ...
  void groupUploadButton(String source) async {
    var camOrGallery = await showDialog(
      context: context,
      builder: (BuildContext context) {
        return PictureOptions();
  ...
  void activityUploadButton(String source) async {
    var camOrGallery = await showDialog(
      context: context,
      builder: (BuildContext context) {
        return PictureOptions();
  ...
  void artworkUploadButton(String source) async {
    var camOrGallery = await showDialog(
      context: context,
      builder: (BuildContext context) {
        return PictureOptions();
                    ...
                    decoration: InputDecoration(
                      suffixIcon: IconButton(
                        icon: Icon(
                          ...
                          color: Resources.colors.appTheme
                              .blue, // Set the color you want here
                        ),
                        onPressed: activityDate,
                      ),
      ...
      child: isLoading
          ...
          : Column(
              ...
              children: [
                    ...
                    children: [
                      ...
                      Container(
                          ...
                          child: ListView.builder(
                              ...
                              itemBuilder: (BuildContext ctxt, int Index) {
                                return buildWaterLevelItem(Index);
                              })),
                      RichText(
                        text: TextSpan(
                      ...
                      Container(
                          ...
                          child: ListView.builder(
                              ...
                              itemCount: 5,
                              itemBuilder: (BuildContext ctxt, int Index) {
                                return buildWeatherCondition(Index);
                              })),
                      RichText(
                        text: TextSpan(
                          text: 'River Pictures',
                ...
                ElevatedButton(
                  onPressed: () =>
                      riverPictureUploadButton('Gallery or Camera'),
                  style: ButtonStyle(
                    backgroundColor:
      ...
      child: isLoading
          ...
          : Column(
              ...
              children: [
                ...
                _error == true
                    ? const Text(
                        "Please select at least 1 surrounding",
                        style: TextStyle(color: Colors.red, fontSize: 10),
                      )
                    : SizedBox(),
                ReactiveForm(
                    ...
                    children: [
                        ...
                        children: WATERANDWEATHER.surroundings.map((item) {
                          return Padding(
                            ...
                            child: ChoiceChip(
                              ...
                              selectedColor:
                                  Resources.colors.appTheme.lightTeal,
                              ...
                              onSelected: (isSelected) {
                                ...
                                form.control('surroundings').value =
                      ...
                      Transform.translate(
                        ...
                        child: CheckboxListTile(
                          ...
                          activeColor: Resources.colors.appTheme.lable,
                          // Set the desired dark blue color
                          checkColor:
                              Colors.white, // Set the check color to white
                        ),
                      ),
                      if (isOthersSelected) ...[
                          ...
                          onPressed: () {
                            ...
                            if (additionalDetails.isNotEmpty) {
                              setState(() {
                                ...
                                selectedSurroundings.add(additionalDetails);
                                _steps = _generateSteps();
                              });
                ...
                SizedBox(height: 16.0),
                ElevatedButton(
                  onPressed: () => surroundingUploadButton('Gallery'),
                  style: ButtonStyle(
                    backgroundColor:
                        MaterialStateProperty.all<Color>(Colors.white),
                    shape: MaterialStateProperty.all<RoundedRectangleBorder>(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      IconButton(
                                        onPressed: () {
                                          setState(() {
                                            surroundingPictures.removeAt(index);
                                            _steps = _generateSteps();
                                            surroundingImgObj.removeAt(index);
                                            _steps = _generateSteps();
                                            if(selectedSurroundingImages.length>0){
                                              selectedSurroundingImages.removeAt(index);
                                            }
                                            _steps = _generateSteps();
                                            surroundingDescriptionsEdit
                                                .removeAt(index);
                                            _steps = _generateSteps();
                                          });
                                        },
                ...
                if (selectedSurroundingImages.isNotEmpty &&
                    selectedSurroundingImages[0].runtimeType != String)
                  Container(
                      margin: EdgeInsets.symmetric(vertical: 20),
                      child: Container(
                          height: 255,
                      ...
                      Row(
                        children: [
                          GestureDetector(
                            ...
                            child: Container(
                              decoration: BoxDecoration(
                                color: _bacteriaPresent == "Present"
                                    ? Resources.colors.appTheme.lightTeal
                                    : Colors.white,
                                // Background color
                ...
                Column(
                  children: [
                    const Align(
                      ...
                      child: Text(
                        'Record the vegetation you can see around you. This could include grasses, shrubs, plants and trees',
                    ...
                    Container(
                      width:
                          double.infinity, // Set the button width to full width
                      child: ElevatedButton(
                        onPressed: () => floraUploadButton('Gallery or Camera'),
                        style: ButtonStyle(
                          backgroundColor:
                              MaterialStateProperty.all<Color>(Colors.white),
                          shape:
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      IconButton(
                                        onPressed: () {
                                          setState(() {
                                            floraPictures.removeAt(index);
                                            _steps = _generateSteps();
                                            floraImgObj.removeAt(index);
                                            _steps = _generateSteps();
                                            if(selectedFloraImages.length>0){
                                              selectedFloraImages.removeAt(index);
                                            }
                                            _steps = _generateSteps();
                                            floraDescriptionsEdit
                                                .removeAt(index);
                                            _steps = _generateSteps();
                                          });
                                        },
                ...
                Column(
                  children: [
                    const Align(
                      alignment: Alignment.centerLeft,
                      child: Text(
                        'Record fish, amphibians, reptiles, birds, insects and mammals that you see around you',
                        // Add your desired text here
                        style: TextStyle(
                          color: Colors.grey, // Set the color to gray
                        ),
                    ...
                    Container(
                      width:
                          double.infinity, // Set the button width to full width
                      child: ElevatedButton(
                        onPressed: () => faunaUploadButton('Gallery or Camera'),
                        style: ButtonStyle(
                          backgroundColor:
                              MaterialStateProperty.all<Color>(Colors.white),
                          shape:
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      IconButton(
                                        onPressed: () {
                                          setState(() {
                                            faunaPictures.removeAt(index);
                                            _steps = _generateSteps();
                                            faunaImgObj.removeAt(index);
                                            _steps = _generateSteps();
                                            if(selectedFaunaImages.length>0){
                                              selectedFaunaImages.removeAt(index);
                                            }
                                            _steps = _generateSteps();
                                            faunaDescriptionsEdit
                                                .removeAt(index);
                                            _steps = _generateSteps();
                                          });
                                        },
          ...
          : Column(
              ...
              children: [
                ...
                Container(
                  ...
                  child: ElevatedButton(
                    onPressed: () => groupUploadButton('Gallery or Camera'),
                    style: ButtonStyle(
                      backgroundColor:
                          MaterialStateProperty.all<Color>(Colors.white),
                      shape: MaterialStateProperty.all<RoundedRectangleBorder>(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      IconButton(
                                        onPressed: () {
                                          setState(() {
                                            groupPictures.removeAt(index);
                                            _steps = _generateSteps();
                                            groupImgObj.removeAt(index);
                                            _steps = _generateSteps();
                                            if(selectedGroupImages.length>0){
                                              selectedGroupImages.removeAt(index);
                                            }
                                            _steps = _generateSteps();
                                            groupImageDescriptionsEdit
                                                .removeAt(index);
                                            _steps = _generateSteps();
                                          });
                                        },
                ...
                Container(
                  width: double.infinity,
                  child: ElevatedButton(
                    onPressed: () => activityUploadButton('Gallery or Camera'),
                    style: ButtonStyle(
                      backgroundColor:
                          MaterialStateProperty.all<Color>(Colors.white),
                      shape: MaterialStateProperty.all<RoundedRectangleBorder>(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      IconButton(
                                        onPressed: () {
                                          setState(() {
                                            activityPictures.removeAt(index);
                                            _steps = _generateSteps();
                                            activityImgObj.removeAt(index);
                                            _steps = _generateSteps();
                                            if(selectedActivityImages.length>0){
                                              selectedActivityImages.removeAt(index);
                                            }
                                            _steps = _generateSteps();
                                            activityImageDescriptionsEdit
                                                .removeAt(index);
                                            _steps = _generateSteps();
                                          });
                                        },
                ...
                Container(
                  width: double.infinity,
                  child: ElevatedButton(
                    onPressed: () => artworkUploadButton('Gallery or Camera'),
                    style: ButtonStyle(
                      backgroundColor:
                          MaterialStateProperty.all<Color>(Colors.white),
                      shape: MaterialStateProperty.all<RoundedRectangleBorder>(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      IconButton(
                                        onPressed: () {
                                          setState(() {
                                            artworkPictures.removeAt(index);
                                            _steps = _generateSteps();
                                            artwrokImgObj.removeAt(index);
                                            _steps = _generateSteps();
                                            if(selectedArtworkImages.length>0){
                                              selectedArtworkImages.removeAt(index);
                                            }
                                            _steps = _generateSteps();
                                            artworkDescriptionsEdit
                                                .removeAt(index);
                                            _steps = _generateSteps();
                                          });
                                        },
                      ...
                      children: <Widget>[
                        ...
                        Container(
                          ...
                          child: Row(
                            ...
                            children: <Widget>[
                              ...
                              Container(
                                alignment: Alignment.centerLeft,
                                child: form.control('waterTesting.pH').value !=
                                        null
                                    ? (() {
                                        final pHValue = double.tryParse(form
                                            .control('waterTesting.pH')
                                            .value);
                                        if (pHValue != null) {
                                          return Text(
                                            ' ${pHValue.toStringAsFixed(2)} ph',
                                            style: TextStyle(
                                              color: (pHValue >= 6.5 &&
                                                      pHValue <= 8.5)
                                                  ? Colors.green
                          ...
                          child: Row(
                            ...
                            children: <Widget>[
                              ...
                              Container(
                                alignment: Alignment.centerLeft,
                                child: form
                                            .control('waterTesting.nitrate')
                                            .value !=
                                        null
                                    ? (() {
                                        final nitrateValue = int.tryParse(form
                                            .control('waterTesting.nitrate')
                                            .value);
                                        if (nitrateValue != null) {
                                          return Text(
                                            '${nitrateValue} mg/L',
                                            style: TextStyle(
                                              color: nitrateValue <= 1
                                                  ? Colors.green
                                                  : Colors.red,
                                              fontWeight: FontWeight.bold,
                                            ),
                          ...
                          child: Row(
                            ...
                            children: <Widget>[
                              ...
                              Container(
                                  alignment: Alignment.centerLeft,
                                  child: form
                                              .control('waterTesting.hardness')
                                              .value !=
                                          null
                                      ? Text(
                                          '${form.control('waterTesting.hardness').value}' +
                                              " mg/L",
                                          style:
                                              TextStyle(
                          ...
                          child: Row(
                            ...
                            children: <Widget>[
                              ...
                              Container(
                                alignment: Alignment.centerLeft,
                                child: form
                                            .control('waterTesting.chlorine')
                                            .value !=
                                        null
                                    ? Builder(
                                        builder: (BuildContext context) {
                                          final chlorineValue = form
                                              .control('waterTesting.chlorine')
                                              .value;
                                          double? parsedValue;
                                          Color textColor;
                                          ...
                                          try {
                                            ...
                                            if (parsedValue != null) {
                                              ...
                                              textColor = Colors
                                                  .red; // You can choose another color if needed
                                            }
                                          } catch (e) {
                                            parsedValue = null;
                                            textColor = Colors.black;
                          ...
                          child: Row(
                            ...
                            children: <Widget>[
                              ...
                              Container(
                                alignment: Alignment.centerLeft,
                                child: form
                                            .control('waterTesting.iron')
                                            .value !=
                                        null
                                    ? (() {
                                        final ironValue = double.tryParse(form
                                            .control('waterTesting.iron')
                                            .value);
                                        if (ironValue != null) {
                                          return Text(
                                            '${ironValue.toStringAsFixed(2)} mg/L',
                                            style: TextStyle(
                                              color: (ironValue >= 0.2 &&
                                                      ironValue <= 2.0)
                                                  ? Colors.green
                            ...
                            children: <Widget>[
                              ...
                              Container(
                                ...
                                child: form
                                    ...
                                    ? Builder(
                                        builder: (BuildContext context) {
                                          final dissolvedOxygenValue = form
                                              .control(
                                                  'waterTesting.dissolvedOxygen')
                                              .value;
                                          double? parsedValue;
                        ...
                        Container(
                          ...
                          child: Row(
                            ...
                            children: <Widget>[
                              Container(
                                  child: Text("E Coli/Coliform Bacteria",
                                      style: TextStyle(
                                          color:
                                              Resources.colors.appTheme.lable,
                                          fontFamily: "WorkSans"))),
                          ...
                          child: Row(
                            ...
                            children: <Widget>[
                              ...
                              Container(
                                  alignment: Alignment.centerLeft,
                                  child: form
                                              .control('waterTesting.turbidity')
                                              .value !=
                                          null
                                      ? Text(
                                          '${form.control('waterTesting.turbidity').value}' +
                                              " NTU",
                                          style: TextStyle(
                                            color: () {
                                              try {
                                                final int intValue = int.parse(form
                                                        .control(
                                                            'waterTesting.turbidity')
                                                        .value ??
                                                    '');
                                                if (intValue <= 15000) {
                                                  return Colors.green;
                          ...
                          child: Row(
                            ...
                            children: <Widget>[
                              ...
                              Container(
                                alignment: Alignment.centerLeft,
                                child: form
                                            .control('waterTesting.phosphate')
                                            .value !=
                                        null
                                    ? Builder(
                                        builder: (BuildContext context) {
                                          final phosphateValue = form
                                              .control('waterTesting.phosphate')
                                              .value;
                                          double? parsedValue;
                                          Color textColor;
                                          ...
                                          try {
                                            parsedValue =
                                                double.tryParse(phosphateValue);
                                            if (parsedValue != null) {
                                              textColor = parsedValue <= 0.1
                                                  ? Colors.green
                                                  : Colors.red;
                                            } else {
                                              // Handle cases where parsing failed
                          ...
                          child: Row(
                            ...
                            children: <Widget>[
                              ...
                              Container(
                                  alignment: Alignment.centerLeft,
                                  child: form
                                              .control('waterTesting.ammonia')
                                              .value !=
                                          null
                                      ? Text(
                                          '${form.control('waterTesting.ammonia').value}' +
                                              " mg/L",
                                          style: TextStyle(
                                            color: () {
                                              final double? doubleValue =
                                                  double.tryParse(form
                                                          .control(
                          ...
                          child: Row(
                            ...
                            children: <Widget>[
                              ...
                              Container(
                                alignment: Alignment.centerLeft,
                                child:
                                    form.control('waterTesting.lead').value !=
                                            null
                                        ? Builder(
                                            builder: (BuildContext context) {
                                              final leadValue = form
                                                  .control('waterTesting.lead')
                                                  .value;
                                              double? parsedValue;
                                              Color textColor;
                                              ...
                                              try {
                                                parsedValue =
                                                    double.tryParse(leadValue);
                                                if (parsedValue != null) {
                                                  textColor = parsedValue == 0
                                                      ? Colors.green
                                                      : Colors.red;
                                                } else {
                                                  // Handle cases where parsing failed
                                      ...
                                      ? Text(
                                          ...
                                          style: TextStyle(
                                            color: () {
                                              ...
                                              return Colors
                                                  .black; // Default color if parsing fails
                                            }(),
                                            fontWeight: FontWeight.bold,
                                          ),
                                        )
                ...
                Theme(
                  ...
                  child: Stepper(
                    ...
                    onStepTapped: (int index) {
                      ...
                      //   _steps = _generateSteps();
                      // });
                      if (steps[_index] != 'flora' &&
                          steps[_index] != 'waterLevelAndWeather' &&
                          steps[_index] != 'preview' &&
                          form.control(steps[_index]).runtimeType ==
                              FormGroup &&
                        ...
                        if (form.control(steps[_index]).valid &&
                          ...
                          form.control(steps[_index]).runtimeType !=
                              FormGroup &&
                          ((form.value['surroundings'] as List<dynamic>)
                                  .isNotEmpty &&
