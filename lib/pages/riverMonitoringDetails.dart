...
class RiverMonitoringDetailsPage extends StatefulWidget {
  ...
  RiverMonitoringDetailsPage({Key? key, required this.waterDetailsId})
      : super(key: key);

  @override
  State<RiverMonitoringDetailsPage> createState() =>
      _RiverMonitoringDetailsPageState();
}

class _RiverMonitoringDetailsPageState
    extends State<RiverMonitoringDetailsPage> {
  ...
  Future<WaterTestDetails> getWaterTestDetail() async {
    final waterTestDetails = await _waterTestDetail.getWaterTestDetailsById(
        widget.waterDetailsId);
    setState(() {
  ...
  Future<WaterTestDetails> deleteWaterTestDetail() async {
    final waterTestDetails = await _waterTestDetail.deleteWaterTestDetailsById(
        widget.waterDetailsId, context);
    return waterTestDetails;
  }
                                        ...
                                        child: Row(
                                          ...
                                          children: <Widget>[
                                            ...
                                            Container(
                                                ...
                                                alignment: Alignment.centerLeft,
                                                child: snapshot.data
                                                    .waterTesting['phosphate'] !=
                                                    null ?
                                                    snapshot.data
                                                        .waterTesting['phosphate']!=""?Text("${snapshot.data
                                                    .waterTesting['phosphate']}" +
                                                    " mg/L",
                                                    style: TextStyle(
                                                        color: int.parse(
                                          ...
                                          children: <Widget>[
                                            ...
                                            Container(
                                                ...
                                                child: snapshot.data
                                                    ...
                                                    " ppm",
                                                  // style:  TextStyle(
                                                  // color:int.parse(snapshot.data.waterTesting['totalDissolvedSolids'])<900
                                                  //     ?Colors.green
                                              ...
                                              itemBuilder:
                                                ...
                                                return Column(
                                                  children: [
                                                    ...
                                                    SizedBox(height: 15,),
                                                    Text('${snapshot.data
                                                        .riverPictures[Index]['description']}')
                                                  ],
                                                );
                                              }))),
                              ],
                                              ...
                                              itemBuilder:
                                                ...
                                                return Column(
                                                  children: [
                                                    ...
                                                    SizedBox(height: 15,),
                                                    Text('${snapshot.data
                                                        .surroundingPictures[Index]['description']}'),
                                                  ],
                                                );
                                              }))),
                              ],
                                              ...
                                              itemBuilder:
                                                ...
                                                return Column(
                                                  children: [
                                                    ...
                                                    SizedBox(height: 15,),
                                                    Text('${snapshot.data
                                                        .floraPictures[Index]['description']}')
                                                  ],
                                                );
                                              }))),
                                Row(
                                              ...
                                              itemBuilder:
                                                ...
                                                return Column(
                                                  children: [
                                                    ...
                                                    SizedBox(height: 15,),
                                                    Text('${snapshot.data
                                                        .faunaPictures[Index]['description']}')
                                                  ],
                                                );
                                              }))),
                              ],
                                              ...
                                              itemBuilder: (BuildContext ctxt,
                                                ...
                                                return Column(
                                                  children: [
                                                    ...
                                                    SizedBox(height: 15,),
                                                    Text('${snapshot.data
                                                        .groupPictures[Index]['description']}')
                                                  ],
                                                );
                                              }))),
                                Row(
                                              ...
                                              itemBuilder: (BuildContext ctxt,
                                                ...
                                                return Column(
                                                  children: [
                                                    ...
                                                    SizedBox(height: 15,),
                                                    Text('${snapshot.data
                                                        .activityPictures[Index]['description']}')
                                                  ],
                                                );
                                              }))),
                                Row(
                                              ...
                                              itemBuilder: (BuildContext ctxt,
                                                ...
                                                return Column(
                                                  children: [
                                                    ...
                                                    SizedBox(height: 15,),
                                                    Text('${snapshot.data
                                                        .artworkPictures[Index]['description']}')
                                                  ],
                                                );
                                              }))),
                              ],
                                              ...
                                              child: TextButton(
                                                  style: TextButton.styleFrom(
                                                    backgroundColor: Resources
                                                        .colors.appTheme
                                                        .darkBlue, // Set the background color
                                                  ),
                                                  onPressed: () {
                                                    _waterTestDetail
                                                        .generateCertificate(
                                                        snapshot.data, context,"create");
                                                  },
                                                  child: Text(
                                                    'Generate certificate',
                                                    style: TextStyle(
                                                      color: Colors
                                                          .white, // Set the font color
                                                    ),)
                                              ),
                                            )
                                        )
